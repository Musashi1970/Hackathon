...
const initialQueue: ReviewItem[] = [
  {
    ...
    confidence: 0.91,
    method: "fuzzy",
    reason: "High confidence (91%), STT phonetic error — 'Nashik' vs 'Mysore'",
  ...
  },
  {
    ...
    confidence: 0.89,
    method: "fuzzy",
    reason: "High confidence (89%), colloquial description",
  ...
  },
  {
    ...
    confidence: 0.87,
    method: "fuzzy",
    reason: "High confidence (87%), item not on menu — closest match proposed",
  ...
  },
  {
    ...
    confidence: 0.93,
    method: "fuzzy",
    reason: "High confidence (93%), modifier 'strong' not in canonical name",
  ...
  },
  {
    ...
    confidence: 0.90,
    method: "fuzzy",
    reason: "High confidence (90%), ambiguous — could be D01, D02, or D04",
  ...
  },
  {
    ...
    confidence: 0.94,
    method: "fuzzy",
    reason: "High confidence (94%), item may not be on menu",
